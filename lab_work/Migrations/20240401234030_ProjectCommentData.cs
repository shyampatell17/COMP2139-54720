...
{
    /// <inheritdoc />
    public partial class ProjectCommentData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PrjectCommentId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectComments", x => x.PrjectCommentId);
                    table.ForeignKey(
